...
@summary: Django settings
'''
import os.path

# Django settings for metalex_web_converter project.
...
DATABASES = {
    'default': {
        ...
        'NAME': '/Users/hoekstra/projects/metalex_web_converter/src/sqlite.db',                      # Or path to database file if using sqlite3.
...
STATICFILES_DIRS = (
    "/Users/hoekstra/projects/metalex/web/src/metalex_web_converter/static/",
...
SECRET_KEY = 'v2jkp2)rx+_c56wzk@)s+)o%8!i^op+#69mxtncowy5k47r*m!'
